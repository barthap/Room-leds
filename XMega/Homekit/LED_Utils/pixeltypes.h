  ...
  /// Array access operator to index into the crgb object
    ...
    inline CRGB& nscale8 (uint8_t scaledown )
    {
	   ...
	   inline CRGB scale8 (const CRGB & scaledown ) const
	    {
		    CRGB out;
		    out.r = FastLed::scale8(r, scaledown.r);
		    out.g = FastLed::scale8(g, scaledown.g);
		    out.b = FastLed::scale8(b, scaledown.b);
		    return out;
	    }
    ...
    {
        r = FastLed::scale8(r, scaledown.r);
        g = FastLed::scale8(g, scaledown.g);
        b = FastLed::scale8(b, scaledown.b);
        return *this;
    }
